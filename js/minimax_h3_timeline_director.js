...
function emptyState() {
  return { version: 6, fps: 24, globalPrompt:"", selection: { start: 0, duration: 5 }, videoAudioEnabled: true, videoClips: [], images: [], audios: [], segmentConfig:{count:1,activeIndex:0,mode:"timeline",segments:createWindows([],1,5*24)} };
}
